...
//For qualified we're also checking the "type" and "encoding" select menus to check for qualified terms and encoding schemes.
	...
	var description = [];
	description = $('input[name="descriptionRow"]');
...
if(addlinkxqualified.attr('checked')){
	...
	generatedXMLCode += "<dc:language xsi:type=\"dcterms:RFC1766\">" + language[i].value + "</dc:language>" + '\n'; 
	generatedHTMLCode +="<meta name=\"DC.Language\" scheme=\"DCTERMS.RFC1766\" content=\"" + language[i].value + "\">" + '\n';
	generatedXHTMLCode +="<meta name=\"DC.Language\" scheme=\"DCTERMS.RFC1766\" content=\"" + language[i].value + "\" />" + '\n';
	}
	else if((language[i].value != "") && (languageType[i].selectedIndex == "4")){	
	generatedXMLCode += "<dc:language xsi:type=\"dcterms:RFC3066\">" + language[i].value + "</dc:language>" + '\n'; 
	generatedHTMLCode +="<meta name=\"DC.Language\" scheme=\"DCTERMS.RFC3066\" content=\"" + language[i].value + "\">" + '\n';
	generatedXHTMLCode +="<meta name=\"DC.Language\" scheme=\"DCTERMS.RFC3066\" content=\"" + language[i].value + "\" />" + '\n';
	}
	else if((language[i].value != "") && (languageType[i].selectedIndex == "5")){	
	generatedXMLCode += "<dc:language xsi:type=\"dcterms:RFC4646\">" + language[i].value + "</dc:language>" + '\n'; 
	generatedHTMLCode +="<meta name=\"DC.Language\" scheme=\"DCTERMS.RFC4646\" content=\"" + language[i].value + "\">" + '\n';
	generatedXHTMLCode +="<meta name=\"DC.Language\" scheme=\"DCTERMS.RFC4646\" content=\"" + language[i].value + "\" />" + '\n';
	}
	else if((language[i].value != "") && (languageType[i].selectedIndex == "6")){	
	generatedXMLCode += "<dc:language xsi:type=\"dcterms:RFC5646\">" + language[i].value + "</dc:language>" + '\n'; 
	generatedHTMLCode +="<meta name=\"DC.Language\" scheme=\"DCTERMS.RFC5646\" content=\"" + language[i].value + "\">" + '\n';
	generatedXHTMLCode +="<meta name=\"DC.Language\" scheme=\"DCTERMS.RFC5646\" content=\"" + language[i].value + "\" />" + '\n';
	}
}
...
if($("#adddeclarationxhtml").attr('checked')){
	...
	document.getElementById('xmlresults').value = generatedXMLCode;
	document.getElementById('htmlresults').value = generatedHTMLCode;
	document.getElementById('xhtmlresults').value = generatedXHTMLCode;
}

function showHideOutput(){
	var value = document.getElementById('outputType').value;
	
	if(value === "xml"){
	document.getElementById('xmlresults').style.display = "inline";
	document.getElementById('xmloptions').style.display = "inline";
	document.getElementById('htmlresults').style.display = "none";
	document.getElementById('htmloptions').style.display = "none";
	document.getElementById('xhtmlresults').style.display = "none";
	document.getElementById('xhtmloptions').style.display = "none";
	}
	else if(value === "html"){
	document.getElementById('xmlresults').style.display = "none";
	document.getElementById('xmloptions').style.display = "none";
	document.getElementById('htmlresults').style.display = "inline";
	document.getElementById('htmloptions').style.display = "inline";
	document.getElementById('xhtmlresults').style.display = "none";
	document.getElementById('xhtmloptions').style.display = "none";
	}
	else if(value === "xhtml"){
	...
	document.getElementById('htmlresults').style.display = "none";
	document.getElementById('htmloptions').style.display = "none";
	document.getElementById('xhtmlresults').style.display = "inline";
	document.getElementById('xhtmloptions').style.display = "inline";
	}
}
